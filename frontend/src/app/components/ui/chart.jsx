  ...
  return /*#__PURE__*/_jsx(ChartContext.Provider, {
    ...
    children: /*#__PURE__*/_jsx("div", _objectSpread(_objectSpread({
      ...
      children: [/*#__PURE__*/_jsx(ChartStyle, {
        id: chartId,
        config: config
      }, void 0, false), /*#__PURE__*/_jsx(RechartsPrimitive.ResponsiveContainer, {
        children: children
      }, void 0, false)]
    }), void 0, true)
  }, void 0, false);
...
function ChartTooltipContent(_ref9) {
    ...
    children: [!nestLabel ? tooltipLabel : null, /*#__PURE__*/_jsx("div", {
      ...
      children: payload.map(function (item, index) {
        ...
        return /*#__PURE__*/_jsx("div", {
          ...
          children: formatter && (item === null || item === void 0 ? void 0 : item.value) !== undefined && item.name ? formatter(item.value, item.name, item, index, item.payload) : /*#__PURE__*/_jsx(_Fragment, {
            children: [itemConfig !== null && itemConfig !== void 0 && itemConfig.icon ? /*#__PURE__*/_jsx(itemConfig.icon, {}) : !hideIndicator && /*#__PURE__*/_jsx("div", {
              ...
              }, void 0, true), item.value && /*#__PURE__*/_jsx("span", {
...
function ChartLegendContent(_ref0) {
  ...
  return /*#__PURE__*/_jsx("div", {
    ...
    children: payload.map(function (item) {
      ...
      return /*#__PURE__*/_jsx("div", {
        ...
        }, void 0, false), itemConfig === null || itemConfig === void 0 ? void 0 : itemConfig.label]
      }, item.value, true);
    })
  }, void 0, false);
}
