...
function ContextMenuSubTrigger(_ref7) {
  ...
  return /*#__PURE__*/_jsx(ContextMenuPrimitive.SubTrigger, _objectSpread(_objectSpread({
...
function ContextMenuCheckboxItem(_ref1) {
  ...
  return /*#__PURE__*/_jsx(ContextMenuPrimitive.CheckboxItem, _objectSpread(_objectSpread({
...
function ContextMenuRadioItem(_ref10) {
  ...
  return /*#__PURE__*/_jsx(ContextMenuPrimitive.RadioItem, _objectSpread(_objectSpread({
