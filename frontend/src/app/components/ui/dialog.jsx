...
function Dialog(_ref) {
  ...
  return /*#__PURE__*/_jsx(DialogPrimitive.Root, _objectSpread({
    "data-slot": "dialog"
  }, props), void 0, false);
}
function DialogTrigger(_ref2) {
  var props = _extends({}, (_objectDestructuringEmpty(_ref2), _ref2));
  return /*#__PURE__*/_jsx(DialogPrimitive.Trigger, _objectSpread({
    "data-slot": "dialog-trigger"
  }, props), void 0, false);
}
function DialogPortal(_ref3) {
  var props = _extends({}, (_objectDestructuringEmpty(_ref3), _ref3));
  return /*#__PURE__*/_jsx(DialogPrimitive.Portal, _objectSpread({
    "data-slot": "dialog-portal"
  }, props), void 0, false);
}
function DialogClose(_ref4) {
  var props = _extends({}, (_objectDestructuringEmpty(_ref4), _ref4));
  return /*#__PURE__*/_jsx(DialogPrimitive.Close, _objectSpread({
...
function DialogOverlay(_ref5) {
  ...
  return /*#__PURE__*/_jsx(DialogPrimitive.Overlay, _objectSpread({
...
function DialogContent(_ref6) {
  ...
  return /*#__PURE__*/_jsx(DialogPortal, {
    "data-slot": "dialog-portal",
    children: [/*#__PURE__*/_jsx(DialogOverlay, {}), /*#__PURE__*/_jsx(DialogPrimitive.Content, _objectSpread(_objectSpread({
      "data-slot": "dialog-content",
      className: cn("bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border p-6 shadow-lg duration-200 sm:max-w-lg", className)
    }, props), {}, {
      children: [children, /*#__PURE__*/_jsx(DialogPrimitive.Close, {
...
function DialogTitle(_ref9) {
  ...
  return /*#__PURE__*/_jsx(DialogPrimitive.Title, _objectSpread({
...
function DialogDescription(_ref0) {
  ...
  return /*#__PURE__*/_jsx(DialogPrimitive.Description, _objectSpread({
