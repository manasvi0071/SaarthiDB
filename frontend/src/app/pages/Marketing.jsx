...
export function Marketing() {
  ...
  var toggleFilter = function toggleFilter(group, value) {
    setSelectedFilters(function (prev) {
      return _extends({}, prev, _defineProperty({}, group, prev[group] === value ? null : value));
    });
  };
  ...
  return _react2.createElement("div", null, _react2.createElement("div", {
    className: "mb-6 flex items-center justify-between"
  }, _react2.createElement("div", null, _react2.createElement("div", {
    className: "flex items-center gap-2"
  }, _react2.createElement(_lucideReact.Megaphone, {
    className: "h-6 w-6 text-blue-500"
  }), _react2.createElement("h1", {
    className: "text-3xl font-bold " + textPrimary
  }, "Marketing")), _react2.createElement("p", {
    className: "mt-1 " + textSecondary
  }, "Reach any company or contact in your database, across email, WhatsApp, and SMS.")), _react2.createElement("button", {
    className: "flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 px-4 py-2.5 font-medium text-white shadow-lg shadow-blue-600/30 transition hover:opacity-90"
  }, _react2.createElement(_lucideReact.Plus, {
    className: "h-4 w-4"
  }), "New campaign")), _react2.createElement("div", {
    ...
    return _react2.createElement("div", {
      ...
      className: "text-sm font-medium " + (s.up ? "text-emerald-500" : "text-red-500")
    }, s.change)), _react2.createElement("p", {
      className: "mt-4 text-3xl font-bold " + textPrimary
    }, s.value), _react2.createElement("p", {
  ...
  }), _react2.createElement("h2", {
    className: "text-lg font-semibold " + textPrimary
  }, "Audience")), Object.entries(segmentFilters).map(function (_ref) {
    ...
    return _react2.createElement("div", {
      ...
      className: "mb-2 text-xs font-semibold uppercase tracking-wide " + (darkMode ? "text-gray-500" : "text-gray-400")
    }, group), _react2.createElement("div", {
      className: "flex flex-wrap gap-2"
    }, options.map(function (opt) {
      var active = selectedFilters[group] === opt;
      return _react2.createElement("button", {
        key: opt,
        onClick: function onClick() {
          return toggleFilter(group, opt);
        },
        className: "rounded-lg px-3 py-1.5 text-sm font-medium transition " + (active ? "bg-gradient-to-r from-blue-600 to-blue-500 text-white shadow-md shadow-blue-600/30" : darkMode ? "bg-[#1a1f2e] text-gray-400 hover:bg-[#232a3d]" : "bg-gray-100 text-gray-600 hover:bg-gray-200")
      }, opt);
    })));
  }), _react2.createElement("button", {
    className: "mt-2 w-full rounded-xl py-2.5 text-sm font-semibold transition " + (darkMode ? "border border-blue-900 bg-blue-950/40 text-blue-400 hover:bg-blue-950/70" : "border border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100")
  }, "Save as segment")), _react2.createElement("div", {
    className: "rounded-2xl p-6 lg:col-span-2 " + cardBase
  }, _react2.createElement("div", {
    className: "mb-4 flex items-center justify-between"
  }, _react2.createElement("h2", {
    className: "text-lg font-semibold " + textPrimary
  }, "Compose"), _react2.createElement("div", {
    className: "flex rounded-xl p-1 " + (darkMode ? "bg-[#1a1f2e]" : "bg-gray-100")
    ...
    return _react2.createElement("button", {
      ...
      className: "flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-sm font-medium transition " + (activeChannel === c.id ? darkMode ? "bg-[#0f1421] text-blue-400 shadow-sm" : "bg-white text-blue-700 shadow-sm" : textSecondary + " hover:" + textPrimary)
  ...
  }), activeChannel === "email" && _react2.createElement("input", {
    type: "text",
    placeholder: "Subject line",
    className: "mb-3 w-full rounded-xl px-4 py-2.5 text-sm focus:outline-none " + inputBase
  }), (activeChannel === "whatsapp" || activeChannel === "sms") && _react2.createElement("input", {
    type: "tel",
    ...
    className: "flex items-center gap-1.5 text-sm font-medium " + textSecondary + " hover:" + textPrimary
  }, _react2.createElement(_lucideReact.Clock, {
    className: "h-4 w-4"
  }), "Schedule for later", _react2.createElement(_lucideReact.ChevronDown, {
    className: "h-3.5 w-3.5"
  })), _react2.createElement("div", {
    className: "flex gap-2"
  }, _react2.createElement("button", {
    className: "rounded-xl px-4 py-2.5 text-sm font-medium transition " + (darkMode ? "border border-gray-700 text-gray-300 hover:bg-[#1a1f2e]" : "border border-gray-200 text-gray-600 hover:bg-gray-50")
  }, "Save draft"), _react2.createElement("button", {
    ...
    className: "h-4 w-4"
  }), "Send campaign"))))), _react2.createElement("div", {
    className: "mt-6 rounded-2xl p-6 " + cardBase
  }, _react2.createElement("h2", {
    className: "mb-4 text-lg font-semibold " + textPrimary
  }, "Recent campaigns"), _react2.createElement("div", {
    className: "overflow-x-auto"
  }, _react2.createElement("table", {
    className: "w-full text-left text-sm"
  }, _react2.createElement("thead", null, _react2.createElement("tr", {
    className: "border-b " + (darkMode ? "border-gray-800 text-gray-500" : "border-gray-100 text-gray-400")
  }, _react2.createElement("th", {
    className: "pb-3 font-medium"
  }, "Campaign"), _react2.createElement("th", {
    className: "pb-3 font-medium"
  }, "Channel"), _react2.createElement("th", {
    className: "pb-3 font-medium"
  }, "Audience"), _react2.createElement("th", {
    className: "pb-3 font-medium"
  }, "Status"), _react2.createElement("th", {
    className: "pb-3 font-medium"
  }, "Sent"), _react2.createElement("th", {
    className: "pb-3 font-medium"
  }, "Opened"), _react2.createElement("th", {
    className: "pb-3 font-medium"
  }, "Replied"))), _react2.createElement("tbody", null, campaigns.map(function (c) {
    var Icon = channelIcon[c.channel];
    return _react2.createElement("tr", {
      key: c.name,
      className: "border-b last:border-0 " + (darkMode ? "border-gray-800/60" : "border-gray-50")
    }, _react2.createElement("td", {
      className: "py-3.5 font-medium " + textPrimary
    }, c.name), _react2.createElement("td", {
      className: "py-3.5"
    }, _react2.createElement(Icon, {
      className: "h-4 w-4 " + textSecondary
    })), _react2.createElement("td", {
      className: "py-3.5 " + textSecondary
    }, c.audience), _react2.createElement("td", {
      className: "py-3.5"
    }, _react2.createElement("span", {
      className: "rounded-full px-2.5 py-1 text-xs font-semibold " + statusStyles[c.status]
    }, c.status)), _react2.createElement("td", {
      className: "py-3.5 " + (darkMode ? "text-gray-300" : "text-gray-700")
    }, c.sent || "—"), _react2.createElement("td", {
      className: "py-3.5 " + (darkMode ? "text-gray-300" : "text-gray-700")
    }, c.opened || "—"), _react2.createElement("td", {
      className: "py-3.5 " + (darkMode ? "text-gray-300" : "text-gray-700")
    }, c.replied || "—"));
  }))))));
}
